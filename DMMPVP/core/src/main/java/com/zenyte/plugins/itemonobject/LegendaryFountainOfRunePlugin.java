...
import static com.zenyte.plugins.itemonobject.FountainOfRunePlugin.*;

public final class LegendaryFountainOfRunePlugin implements ItemOnObjectAction {

    private static final Location PROJECTILE_START_LOCATION = new Location(3381, 7594, 0);
