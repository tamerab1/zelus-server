...
@Suppress("unused")
class UrzothDropTable : NPCDropTableScript() {

    init {
        // Icefiend variants this table applies to.
        npcs(Urzoth_the_Hellgorilla)
        ...
        onDeath {
            ...
            if (playerDamageContributions.isEmpty()) {
                killer.sendDeveloperMessage("No damage dealers recorded; skipping Urzoth drops.")
                return@onDeath
            }

            // MVP = highest damage contributor
            val mvp = playerDamageContributions.maxBy { it.value }.key
            mvp.sendDeveloperMessage("You are MVP (Urzoth the Hellgorilla) with ${(playerDamageContributions[mvp] ?: 0.0) * 100}% damage.")
        ...
        buildTable {
            ...
            Unique {
                // -- existing
                ItemId.VOIDWAKER_27690         quantity 1   oneIn 10000
                ItemId.DRAGON_CLAWS            quantity 1   oneIn 600
                CustomItemId.DEATH_CAPE        quantity 1   oneIn 15000        // adjust to your custom id if named differently
                ItemId.SCYTHE_OF_VITUR         quantity 1   oneIn 15000       // change if your constant differs

                // -- high-end raid/mega rares (very rare)
                ItemId.TWISTED_BOW             quantity 1   oneIn 15000
                ItemId.ELYSIAN_SPIRIT_SHIELD   quantity 1   oneIn 15000
                ItemId.TORVA_FULLHELM        quantity 1   oneIn 8000       // if present in your base
                ItemId.TORVA_PLATEBODY         quantity 1   oneIn 8000
                ItemId.TORVA_PLATELEGS         quantity 1   oneIn 8000
                ItemId.URSINE_CHAINMACE_U_27657 quantity 1 oneIn 1000
                ItemId.WEBWEAVER_BOW_U_27652 quantity 1 oneIn 1500
                ItemId.LIME_WHIP quantity 1 oneIn 50000
                ...
                ItemId.ULTOR_RING_28307 quantity 1 oneIn 8000
                ItemId.VENATOR_RING_28310 quantity 1 oneIn 5500
                ItemId.MAGUS_RING_A quantity 1 oneIn 5500
                ItemId.PVP_MYSTERY_BOX quantity 1 oneIn 1000


                // -- top-tier PvM uniques (rare)
                ItemId.GHRAZI_RAPIER           quantity 1   oneIn 3000
                ItemId.OSMUMTENS_FANG quantity 1 oneIn 5000
                ItemId.SANGUINESTI_STAFF       quantity 1   oneIn 2500
                ItemId.KODAI_WAND              quantity 1   oneIn 1500
                ItemId.ARMADYL_GODSWORD        quantity 1   oneIn 50
                ItemId.BANDOS_GODSWORD         quantity 1   oneIn 600
                ItemId.DRAGON_WARHAMMER        quantity 1   oneIn 750
                ItemId.DINHS_BULWARK           quantity 1   oneIn 4500
                ItemId.RING_OF_SUFFERING       quantity 1   oneIn 800
                ItemId.NECKLACE_OF_ANGUISH     quantity 1   oneIn 400
                ItemId.AMULET_OF_TORTURE       quantity 1   oneIn 400
            }
